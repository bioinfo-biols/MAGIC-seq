...
project_path=/Public_data/Decoder-seq/NBT_Yang
#Barcode-info
whitelist=${project_path}/data/Barcode-T3-50/whitelist
ID=${project_path}/data/Barcode-T3-50/T3-ids-barcode.txt
#result_path
...
do
    ...
    seqkit subseq -j 10 -r 39:58  ${sampath}/${sample}_split/out/${sample}_R1.part_\${file}.fastq.gz -o test27-75.fastq.gz
