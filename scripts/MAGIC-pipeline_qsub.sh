...
project_path=/MAGIC_seq/Mouse_Adult_Organ_T9_70_50um
#Barcode-info
...
ANN=/ref_mm10_M23_release98/mm10_filtered.gtf
#Other-info
...
/histor/zhao/pangkun/software/st_pipeline/scripts/st_pipeline_run.py \\
  --output-folder ./ \\
  --temp-folder ./tmp \\
...
/histor/zhao/pangkun/software/STAR/source/STAR  --genomeDir ${MAP} \\
